...
class CV_Pipeline:
    ...
    def test_specific_subset(self, histogram_size, exclude_outlier_cores, p, predictive_channel_job, path_dir):
        ...
        for predictive_channel in [predictive_channel_job]:
            reports = dict()
            processing = min_max_intersection(percentiles, histogram_size, exclude_outlier_cores, self.data_root_directory)
...
def main():
    ...
    experiments_dir = os.path.join(experiments_dir, 'baseline_cv_train_eval')
