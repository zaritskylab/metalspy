...
class CV_Pipeline:
    ...
    def experiment(self, config):
        ...
        self.test_specific_subset(config["hist_size"], config['exclude_outlier_cores'], config["metal"], config["p"], experiment_dir)
...
def main():
    ...
    experiments_dir = os.path.join(experiments_dir, 'yeo_johnson_cv_train_eval')
